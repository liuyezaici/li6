...
class Application extends Container
{
     ...
     */
    protected $providers = [
        'EasyWeChat\Foundation\ServiceProviders\FundamentalServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\ServerServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\UserServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\JsServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\OAuthServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\MenuServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\NoticeServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\MaterialServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\StaffServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\UrlServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\QRCodeServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\SemanticServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\StatsServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\PaymentServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\POIServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\ReplyServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\BroadcastServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\CardServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\DeviceServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\ShakeAroundServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\OpenPlatformServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\MiniProgramServiceProvider',
        'EasyWeChat\Foundation\ServiceProviders\CommentServiceProvider',
    ];
