(function (global__, $) {
    ...
    global__.frontCfg = {
        ...
        ,submitFromUrl: '/adppp/juzi/api/juzifrom/add'  //发布文集
        ,searchAuthorUrl: '/adppp/juzi/api/juziauthor/search'  //搜索作者
        ,searchFromUrl: '/adppp/juzi/api/juzifrom/search'  //搜索来源
        ,getAllFromTypeUrl: '/adppp/juzi/api/juzifrom/getAllFromType'  //获取来源分类
        ...
        ,editFromUrl : '/adppp/juzi/api/juzifrom/edit/id/' //修改来源
        ,getJuziUrl : '/adppp/juzi/api/index/get/id/' //获取句子
        ,getFromUrl : '/adppp/juzi/api/juzifrom/get/id/' //获取文集
        ...
        '                <li><a target="_self" href="javascript: void(0);" class="writejz_btn">发布句子</a></li>\n' +
        ...
        checkLogin : function () {
            ...
            postAndDone({
                ...
                success_func: function (response) {
                    ...
                    topMenu.find('.writejz_btn').click(function () {
        ...
        loginIn: function () {
            ...
            var loginBodyObj = makeForm({
                ...
                success_func: function (res) {
                    ...
                    hideAllBox();
                    msgTisf(res.msg);
                    parent.window.location = '/?token='+ res.data.token;
                            ...
                            td: {
                                ...
                                value: [
                                    makeInput({
                                        ...
                                        li_num: 5,
                                        keyup: function(obj) {
                                            var authorStr = writeObj.findName('authorStr').value;
                                            obj.url = global__.frontCfg.searchFromUrl + '?author='+ authorStr;
                                        },
                                        menu: {
                                            li: {
                                                show: '{id}',
