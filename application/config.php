...
return [
    ...
    'fastadmin'              => [
        ...
        'api_url'          => 'http://api.*.net',
    ],
    'baiduApiKey' => 'CtF2D4GaU9TGt1wb0bvpHezB',
    'qqApiKey' => 'MYUBZ-ZVP3V-Q5YPG-ULZFZ-OOEI6-DMB3E',
    'qqApiName' => 'myapp',
    'smsTestIgnore' => true, //是否不发短信 测试模式下可以去掉
    'loginTimeOutCode' => 10000, //未登录的提示代码
    'norightCode' => 10001, //没有权限的提示代码
    'test_token' => '', //测试token 078c8787-0f0d-4771-9b58-79be468992dd
];
