...
class Auth
{
    ...
    public function login($username, $password, $keeptime = 0)
    {
        ...
        if ($admin->password && $admin->password != $admin->encryptPassword($password, $admin->salt))
        {
     ...
     * @return string
     */
    public function getEncryptPassword($password, $salt = '', $encrypt='md5')
    {
