...
return [
    ...
    // redis缓存 非框架自动调取的配置 用于手动的extend中调取
    'redis'        => [
        'single'  => [
            'address' => 'pomcube.pehexp.0001.usw2.cache.amazonaws.com', 'port' => 6379, 'password' => '',
//            'address' => '192.168.0.41', 'port' => 6379, 'password' => '123456' , //测试环境redis
        ],
        'cluster' => [
