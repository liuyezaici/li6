function fullAvatarEditor() {
	...
	var file			= '/include/lib/flash_upload/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/include/lib/flash_upload/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 600;							//flash文件的宽度
	var	height			= 433;							//flash文件的高度
	var container		= id;							//装载flash文件的容器(如div)的id
	var flashvars		= {
        src_size: '10MB',
        src_size_over_limit:'10MB'
    };
