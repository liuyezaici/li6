...
require_once __DIR__ . '../src/OssClient.php';
require_once __DIR__ . '../src/Core/OssException.php';

require_once __DIR__ . '../src/Model/LifecycleAction.php';
require_once __DIR__ . '../src/Model/LifecycleConfig.php';
require_once __DIR__ . '../src/Model/LifecycleRule.php';
