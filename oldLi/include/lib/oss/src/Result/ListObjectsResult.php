...
require_once realpath(dirname(__DIR__)) . '/Core/OssUtil.php';
require_once realpath(dirname(__DIR__)) . '/Model/ObjectInfo.php';
require_once realpath(dirname(__DIR__)) . '/Model/ObjectListInfo.php';
require_once realpath(dirname(__DIR__)) . '/Model/PrefixInfo.php';
