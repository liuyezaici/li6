...
final class erweima {
     ...
     * @return bool
     */
    public function draw($text, $size = 150) {
        $this->_data = $text;
        $filename     = $GLOBALS['cfg_erweimaPath']. "/". md5($text) . '.png';
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, "chs={$size}x{$size}&cht=qr&chld=Q|1&chl=" . urlencode($this->_data));
...
/*// 生成二维码 Demo
$qrimage_path     = $_SERVER["DOCUMENT_ROOT"].'/log/erweima';
$qr             = new erweima();
