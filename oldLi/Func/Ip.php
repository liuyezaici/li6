...
class Ip {
    ...
    public static function getIpCity() {
        ...
        $IpInfo = DbBase::getRowBy('s_ip_area', 's_region,s_regionid,s_city,s_cityid', "s_ip='". $ipFront3 ."'");
        if($IpInfo) {
            return array(
            ...
            //淘宝IP接口 不稳定 有点卡
            $addressInfo = Func::get_nr("http://ip.taobao.com/service/getIpInfo.php?ip=".$IP);
            ...
            if($addressInfo) {
                ...
                DbBase::insertRows('s_ip_area', $newIpData);
                return array(
                    $province . '-'. $city,
                    $provinceId,
                    $city_id
