...
class DbBase
{
    ...
    protected static $dbCfg = [
        'db'           => [
            'base'      => [
                'master' => [
                    'dsn'      => 'mysql:host=192.168.0.189;port=3306;dbname=Rio',
                    'user'     => 'im_master',
                    'password' => 'wLp1VoZ0wfx7H4VK78'
                ],
                'slave'  => [
                    'dsn'      => 'mysql:host=192.168.0.189;port=3306;dbname=Rio',
                    'user'     => 'im_slave',
     ...
     * @param bool $mod
     */
    public static function init($mod='master')
    {
        try {
            //读取配置文件
            self::$setting = self::$dbCfg['db']['base'];
//            print_r('setting:');
//            print_r(self::$setting);
     ...
     * @throws \PDOException
     */
    public static function update(string $sql,$params=null)
    {
        try {
     ...
     * @throws \Exception
     */
    public static function getRows(string $sql, $params=null)
    {
        try {
     ...
     * @throws \Exception
     */
    public static function getRow(string $sql,$params=null)
    {
        try {
            //特殊查询，比如按日期条件查的，可记到缓存
            if(is_null(self::$slave_ins)){
     ...
     * @throws \Exception
     */
    public static function getValue(string $sql,$params=null)
    {
        try {
            //特殊查询，比如按日期条件查的，可记到缓存
            if(is_null(self::$slave_ins)){
     ...
     * @throws \PDOException
     */
    public static function getObject(string $sql, string $field, $params=null, $cache=0)
    {
     ...
     * @throws \PDOException
     */
    public static function insertRows(string $table, array $data)
    {
